...
# Calculate average crashes per weather condition
...
# Aggregate data by the binned temperature
...
# Aggregate data by binned temperature using average instead of sum
...
# Compare injury/fatality rates during rain vs. non-rain
rain_summary <- df %>%
  group_by(is_rain) %>%
  summarize(
...
# Analyze crash severity by visibility conditions
...
# Analyze crashes by wind speed categories
